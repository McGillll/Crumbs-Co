        ...
        return (
            <>
                <div className="mx-24 flex">
                    <div className='w-1/3'>
                        <img
                            className='object-cover rounded-l-lg w-fit h-full'    
                    ...
                    <div className='w-2/3 bg-neutral-50 rounded-r-lg shadow-md flex flex-col p-10 items-center justify-center'>
                        ...
                        <p className="text-md text-amber-700 mt-2 italic">
                            <strong>Order Now & Savor Every Bite!</strong>
                        </p>
                        <Link 
                            to="/auth" 
                            className="mt-5 bg-orange-400 text-white px-6 py-3 rounded-lg hover:bg-orange-600 transition-all"
                        >
                            Order Now
                        </Link>
                    </div>

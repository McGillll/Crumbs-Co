    ...
    <>
        <div className='relative h-screen w-screen'>    
          <div className=' absolute inset-0 '>
              <img className='object-cover w-full h-full' src="https://images.unsplash.com/photo-1597528662465-55ece5734101?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"/>
          </div>
            ...
            <div className='h-screen w-full flex justify-center items-center'>
              <div className='flex gap-5'>
                ...
                <div className='flex flex-col gap-2'>
                  ...
                  <span className='mb-auto text-lg font-medium text-neutral-300'>Freshly Baked Joy, Delivered to Your Door!</span>
                </div>
              </div>
            </div>
          </div>
